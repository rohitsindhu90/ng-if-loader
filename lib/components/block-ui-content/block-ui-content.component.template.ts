...
<div *ngIf="enabled" [@fade]="getAnimationState()" class="block-ui-wrapper  {{name}} {{className}} {{customClass}}" [ngClass]="{ 'active': state.blockCount > 0,'in-active':state.blockCount==0 }">
